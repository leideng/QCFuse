...
class Engine(EngineBase):
    ...
    def generate(
        ...
        method: Optional[str] = "attn",
        separator: Optional[str] = "<|blendsep|>",
        ...
        obj = GenerateReqInput(
            ...
            attn_end=attn_end,
            is_contextblend=is_contextblend,
            context_cache_source=context_cache_source,
            context_n_sink=context_n_sink,
            digest_ratio=digest_ratio,
            digest_index_method=digest_index_method,
            critical_layers=critical_layers,
            ssd_cache_path_chunk=ssd_cache_path_chunk,
            ssd_cache_path_query=ssd_cache_path_query,
        )
