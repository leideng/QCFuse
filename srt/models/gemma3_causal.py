...
class Gemma3Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Ensure q and k are 4D before permute
        q = q.permute(0, 2, 1, 3)
        k = k.permute(0, 2, 1, 3)
...
class Gemma3TextModel(PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        position_embeddings_global = self.rotary_emb(hidden_states, tmp_pos)
        position_embeddings_local = self.rotary_emb_local(hidden_states, tmp_pos)
